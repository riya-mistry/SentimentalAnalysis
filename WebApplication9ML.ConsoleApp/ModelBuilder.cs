...
namespace WebApplication9ML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\lenovo\Desktop\wikiDetoxAnnotated40kRows.tsv.txt";
        private static string MODEL_FILEPATH = @"../../../../WebApplication9ML.Model/MLModel.zip";
